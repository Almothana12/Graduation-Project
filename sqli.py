...
# session.headers.update({'Cookie': 'PHPSESSID=ctgd2jigvorbntt2hfm4o7sltm; security=medium'})
# test = {
#     "PHPSESSID": "2r5bfcokovgu1hjf1v08amcd1g"
# }
...
def scan_sql_injection(url):
    ...
    for c in "\"'":
        ...
        if is_vulnerable(response):
            ...
            # no need to precede for extracting forms and submitting them
...
if __name__ == "__main__":
    ...
    for form in forms:
        ...
        for c in "\"'":
        # c = "'"
            response, data = HTMLParser.submit_form(form_details, url, c, session)
            if is_vulnerable(response):
                print("TRUE")
            else:
                print("FALSE")
